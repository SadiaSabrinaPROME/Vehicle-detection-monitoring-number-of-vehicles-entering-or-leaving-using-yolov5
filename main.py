...
cap=cv2.VideoCapture('/home/sadiaprome/Downloads/win11vehiclecount-main/highway.mp4')
...
area1=[(366,436),(346,547),(526,482),(524,449)]
...
while True:
    ...
    a1=len(area_1)
    cv2.putText(frame,('IN:')+str(a1),(36,36),cv2.FONT_HERSHEY_PLAIN,3,(0,0,0),2)
    a2=len(area_2)
    cv2.putText(frame,('OUT:')+str(a2),(669,36),cv2.FONT_HERSHEY_PLAIN,3,(0,0,0),2)
